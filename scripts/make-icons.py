...
d.text((360, 200), 'HEIC → JPG / PNG', font=font_b, fill='white')
d.text((360, 290), 'iPhone写真を一括変換', font=font_b, fill=(196, 181, 253))
d.text((360, 400), 'ブラウザの中だけで変換。画像はどこにも送信されません。', font=font_m, fill=(226, 232, 240))
d.text((360, 470), 'インストール不要・無料・Windows / Mac / iPhone', font=font_s, fill=(148, 163, 184))
